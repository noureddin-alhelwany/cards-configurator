...
class OrderRecord(Base):
    ...
    category_id: Mapped[str] = mapped_column("category_id", String(255), nullable=False)
...
class RenderJobRecord(Base):
    ...
    __table_args__ = (UniqueConstraint("order_id", "kind", name="uq_render_jobs_order_kind"),)

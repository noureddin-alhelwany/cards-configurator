...
Implement typed, versioned file-backed registries for categories, products and templates.

## Acceptance criteria

- [ ] Pydantic schemas cover category, product and initial template definition.
...
- No SQL tables for categories, products or templates.
- Schema must be sufficient for the shared renderer proof, not a generic template-builder language.

## Result

- Changed: added typed file-backed registries for categories, products and templates; wired startup loading; added shared proof fixture APIs; added the deterministic proof screenshot baseline and backend render/PDF validation.
